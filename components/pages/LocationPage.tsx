...
const LocationPageComponent = ({ data }: { data: LocationPage }) => {
  ...
  return (
    <main className={clsx(']')}>
      <section
        className={clsx(
          'bg-lavender grid grid-cols-2 gap-x-[24px] px-[48px] py-[201px] relative items-end',
        )}
      >
        <Image
          ...
          height={108}
          className={clsx(
            'w-[212px] absolute top-[48px] left-[48px] z-[2]',
            'lg:w-[244.71px]',
          )}
        />
        <Image
        ...
        <article className={clsx('relative z-[2]')}>
          ...
          <h1
            className={clsx(
              'text-white text-[90px] leading-[99px] font-codec-heavy mt-[26px]',
            )}
          >
            {data?.title}
          </h1>
          <div
            className={clsx(
              'mt-[55px] grid grid-cols-2 gap-x-[24px] gap-y-[37px]',
            )}
          >
            ...
            <div className={clsx('flex flex-col gap-y-[6px]')}>
              <h6
                className={clsx(
                  'opacity-70 font-codec-news text-white uppercase text-[14px] leading-[14px] tracking-[1.6px]',
                )}
              >
                Services
              </h6>
              <ul
                className={clsx(
                  'text-white font-codec-news text-[18px] leading-[27px] flex flex-col gap-y-[6px]',
                )}
              >
...
function DetailCard({
  ...
  return (
    <div className={clsx('max-w-[200px] flex flex-col gap-y-[6px]')}>
      ...
      <p
        className={clsx(
          'text-white font-codec-news text-[18px] leading-[27px]',
        )}
      >
        {content}
      </p>
